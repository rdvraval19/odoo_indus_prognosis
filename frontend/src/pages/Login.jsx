...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Simulate API login - Update with your real API call later
    login({ name: 'Rahul' }, 'fake-jwt-token');
    navigate('/');
  };
      ...
      <form onSubmit={handleLogin} className="bg-white p-10 rounded-2xl shadow-2xl w-[400px]">
        ...
        <div className="space-y-5">
          <div>
            ...
            <input type="email" required className="w-full border p-3 rounded-xl outline-blue-600" onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Password</label>
            <input type="password" required className="w-full border p-3 rounded-xl outline-blue-600" onChange={(e) => setPassword(e.target.value)} />
          </div>
...
>>>>>>> a6c281ca7deb3f1660ca29e4576ab04d335cbe31:src/pages/Login.jsx
